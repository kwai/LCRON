...
from metrics import evaluate_3stage, evaluate_join_3stage
...
if __name__ == '__main__':
    ...
    def run_eval():
        ...
        for epoch in [args.epochs]:
            ...
            rank_model.load_state_dict(state_dict)
            ...
            n_day = 0
            dataset = Rank_Train_All_BY_RERANK_Dataset(
            ...
            evaluate_join_3stage(rank_model, prerank_model, retrival_model, loader, device, desc="%s\t%s" % (args.loss_type, "joint"))

            for model, name in [[rank_model, "rank"], [prerank_model, "prerank"], [retrival_model, "retrival"]]:
                dataset = Rank_Train_All_BY_RERANK_Dataset(
                    path_to_eval_csv_lst[n_day],
                    args.seq_len,
                    path_to_eval_seq_pkl_lst[n_day],
                ...
                evaluate_3stage(model, loader, device, is_debug=False, desc="%s\t%s"%(args.loss_type, name))
