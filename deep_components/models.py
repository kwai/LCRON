...
class DIN(nn.Module):
  ...
  def forward_all_by_rank(self, inputs):
    request_wday, request_hour, request_min, \
      ...
      rank_pos_photos, rank_neg_photos, coarse_neg_photos, prerank_neg_photos = inputs
    ...
    return rank_pos_logits, rank_neg_logits, coarse_neg_logits, prerank_neg_logits
